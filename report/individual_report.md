...
| Thông tin         | Nội dung                                                        |
| ------------------ | ---------------------------------------------------------------- |
| Họ và tên       | Đinh Lê Quỳnh Phương (Thành viên 3)                             |
| MSSV               | 2A202601865                                                      |
| Khóa/Lớp         | K3                                                               |
| Tên nhóm         |                                                                 |
| Vai trò chính    | Observability Owner (Data Quality, Freshness & Reporting)        |
| Repository         | `d:\K3_Day10_Data-Pipeline-Data-Observability`                   |
